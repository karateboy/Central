    ...
    implicit request =>
      ...
      reportType match {
        case PeriodReport.DailyReport =>
          ...
          val periodMap = recordOp.getRecordMap(recordOp.HourCollection)(monitor, mtList, startDate, startDate + 1.day)
        ...
        case PeriodReport.MonthlyReport =>
          ...
          val periodMap = recordOp.getRecordMap(recordOp.HourCollection)(monitor, monitorTypeOp.activeMtvList, start, start + 1.month)
